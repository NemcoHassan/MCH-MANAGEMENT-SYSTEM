...
<body>
   ...
   <?php include("nav.php");?>
            ...
            <!-- Mobile Menu end -->
            <div class="breadcome-area"  style="background-color:#DD2F6E;color:white;font-weight:bold;">
                                ...
                                <div class="row"  style="color:white;">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcome-heading">
                                            <form role="search" class=""style="color:white;"  >
                                                <input type="text" placeholder="Search..." class="form-control" style="color: white;">

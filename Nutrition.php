...
if(isset($_POST['save'])){
  ...
  $Gender=$_POST['gender'];
  $type_nutrition=$_POST['type'];
  if(!empty($FullName)&& !empty($Age)&& !empty($Age)&& !empty($Tellphone)&& !empty($Gender)&& !empty($type_nutrition))
  {
    $sql="INSERT INTO `nutrition` (`ID`, `Name`, `Date`, `Age`, `telphone`, `gender`, `typenutrition`) VALUES
   ('$ID', '$FullName', '$Date', '$Age', '$Tellphone', '$Gender', '$type_nutrition');";
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-6 col-sm-6 col-xs-12">
                <div class="text-center custom-login">
                    <h3 style="color:#DD2F6E; font-weight:bold;">NUTRITION</h3>
                    <p style="color:#DD2F6E; font-weight:bold;">Nutrition Form Data </p>
                </div>
                <div class="hpanel">
